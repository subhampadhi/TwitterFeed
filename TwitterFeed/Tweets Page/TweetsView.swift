...
class TweetsView: UIViewController {
    ...
    func setUpNavBar()  {
        navigationItem.title = "TWITTER FEEDS"
    ...
    func pullToRefresh() {
        ...
        refreshControl.addTarget(self, action: #selector(TweetsVC.refresh), for: UIControl.Event.valueChanged)
