...
extension TweetsTVCHelper: CellFunctions {
    
    static func registerCell(tableView: UITableView) {
        tableView.register(TweetsTVC.self, forCellReuseIdentifier: "tweetsTVC")
    }
    
    func cellInstantiate(tableView: UITableView, indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "tweetsTVC", for: indexPath) as! TweetsTVC
