...
class TweetsTVC: UITableViewCell {
    ...
    func addBottomStack() {
        ...
        commentButton.setImage(#imageLiteral(resourceName: "Image"), for: .normal)
        commentButton.setTitleColor(#colorLiteral(red: 0.6666666865, green: 0.6666666865, blue: 0.6666666865, alpha: 1), for: .normal)
//        commentButton.widthAnchor.constraint(equalToConstant: 70).isActive = true
//        commentButton.heightAnchor.constraint(equalToConstant: 70).isActive = true
        
        bottomStack.addArrangedSubview(retweetButton)
        retweetButton.setImage(#imageLiteral(resourceName: "Image-1"), for: .normal)
        commentButton.setTitleColor(#colorLiteral(red: 0.6666666865, green: 0.6666666865, blue: 0.6666666865, alpha: 1), for: .normal)
//        retweetButton.widthAnchor.constraint(equalToConstant: 70).isActive = true
//        retweetButton.heightAnchor.constraint(equalToConstant: 70).isActive = true
        
        bottomStack.addArrangedSubview(likeButton)
        likeButton.setImage(#imageLiteral(resourceName: "like_icon"), for: .normal)
        commentButton.setTitleColor(#colorLiteral(red: 0.6666666865, green: 0.6666666865, blue: 0.6666666865, alpha: 1), for: .normal)
//        likeButton.widthAnchor.constraint(equalToConstant: 70).isActive = true
