...
extension ProfileHeaderTVCHelper: CellFunctions {
    
    static func registerCell(tableView: UITableView) {
        tableView.register(ProfileHeaderTVC.self, forCellReuseIdentifier: "profileHeaderTVC")
    }
